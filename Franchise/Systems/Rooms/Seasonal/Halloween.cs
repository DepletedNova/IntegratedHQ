...
namespace KitchenHQ.Franchise
{
    ...
    public class CreateHalloweenDecorations : SeasonalFranchiseBuildSystem
    {
        ...
        protected override void AddDecorations()
        {
            ...
            Create(cobweb, LobbyPositionAnchors.Workshop + new Vector3(0f, 0f, 11f), Vector3.left);
            Create(cobweb, LobbyPositionAnchors.Garage + new Vector3(5f, 0f, 5f), Vector3.forward);

            // Pumpkins
            var pumpkin1 = GetCastedGDO<Appliance, Pumpkin1>();
            var pumpkin2 = GetCastedGDO<Appliance, Pumpkin2>();
            Create(pumpkin1, LobbyPositionAnchors.Office + new Vector3(6f, 0f, 0f), Vector3.forward);
            Create(pumpkin2, LobbyPositionAnchors.Office + new Vector3(-6f, 0f, 0f), Vector3.forward);
            Create(pumpkin2, LobbyPositionAnchors.Workshop + new Vector3(5f, 0f, 8f), Vector3.right);
